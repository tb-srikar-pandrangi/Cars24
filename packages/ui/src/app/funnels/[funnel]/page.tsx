...
type StatusData = {
  diagnosis: Array<{ campaignId: string; funnel: string; geo: string; issues: any[] }>;
      ...
      try {
        ...
        const mockCampaigns: Record<string, Campaign[]> = {
          SELL: [
            ...
            { campaignId: 'camp_002', campaignName: 'SELL_Delhi_Google_Branded', geo: 'Delhi', spend: 38000, cpl: 1210, cma: 2420 },
            { campaignId: 'camp_003', campaignName: 'SELL_Mumbai_Meta_Retargeting', geo: 'Mumbai', spend: 52000, cpl: 1150, cma: 2300 },
          ],
          BUY: [
            { campaignId: 'camp_004', campaignName: 'BUY_Bengaluru_Google_NonBranded', geo: 'Bengaluru', spend: 42000, cpl: 1420, cma: 3850 },
            { campaignId: 'camp_005', campaignName: 'BUY_Hyderabad_YouTube_Awareness', geo: 'Hyderabad', spend: 35000, cpl: 1380, cma: 3720 },
            { campaignId: 'camp_006', campaignName: 'BUY_Pune_Google_Remarketing', geo: 'Pune', spend: 28000, cpl: 1450, cma: 3950 },
          ],
          FINANCE: [
            { campaignId: 'camp_007', campaignName: 'FINANCE_Mumbai_Google_Search', geo: 'Mumbai', spend: 48000, cpl: 980, cma: 2100 },
            { campaignId: 'camp_008', campaignName: 'FINANCE_Ahmedabad_Meta_LAL', geo: 'Ahmedabad', spend: 32000, cpl: 920, cma: 1980 },
            { campaignId: 'camp_009', campaignName: 'FINANCE_Jaipur_Google_EMIKeywords', geo: 'Jaipur', spend: 25000, cpl: 940, cma: 2050 },
          ],
          SERVICES: [
            { campaignId: 'camp_010', campaignName: 'SERVICES_Delhi_Meta_Retargeting', geo: 'Delhi', spend: 38000, cpl: 1520, cma: 3280 },
            { campaignId: 'camp_011', campaignName: 'SERVICES_Kolkata_Meta_PostTxn', geo: 'Kolkata', spend: 22000, cpl: 1480, cma: 3200 },
            { campaignId: 'camp_012', campaignName: 'SERVICES_Hyderabad_Google_Remarketing', geo: 'Hyderabad', spend: 29000, cpl: 1550, cma: 3350 },
          ],
        };
        setCampaigns(mockCampaigns[funnel] || []);
      } finally {
        setLoading(false);
      }
    };
